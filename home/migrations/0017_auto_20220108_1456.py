...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='connect',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.usercontainer'),
        ),
        migrations.AddField(
            model_name='allquizes',
            name='tutorName',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='userFinal', to=settings.AUTH_USER_MODEL),
        ),
    ]
